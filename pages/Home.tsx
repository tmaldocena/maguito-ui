...
const Home: React.FC = () => {
  useEffect(() => {
    document.title = 'MaguitoUI — Bold React Component Library | Neo-Brutalist Design System';
    ...
    <div className="space-y-16 md:space-y-32">
      ...
      <section className="relative overflow-hidden bg-maguito-blue/10 border-4 border-maguito-black rounded-maguito-lg p-6 sm:p-12 md:p-24 flex flex-col lg:flex-row items-center gap-10 md:gap-16 shadow-maguito-lg">
        <div className="flex-1 space-y-6 md:space-y-10 text-center lg:text-left z-10">
          ...
          <h1 className="text-4xl sm:text-6xl md:text-8xl font-black leading-[0.9] text-maguito-black tracking-tighter italic uppercase">
            UI Mágico para<br />
            <span className="bg-maguito-yellow px-3 py-1 md:px-4 md:py-2 border-2 md:border-4 border-maguito-black shadow-maguito md:shadow-maguito-lg inline-block my-2 md:my-4 text-maguito-black rotate-2">Mentes Creativas.</span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-8 justify-center lg:justify-start pt-4">
            <Button size="lg" onClick={() => navigate('/intro')} className="w-full sm:w-auto h-16 md:h-20 px-6 md:px-8 text-lg md:text-xl">
              Conocé MaguitoUI
            </Button>
            <Button size="lg" variant="ghost" onClick={() => navigate('/installation')} className="w-full sm:w-auto text-lg md:text-xl group">
              Instalar Paquete
            </Button>
          </div>
        </div>
        ...
        <div className="flex-1 relative w-full lg:w-auto">
          <div className="relative z-10 w-full max-w-sm md:max-w-lg mx-auto">
            <div className="border-4 border-maguito-black rounded-full overflow-hidden aspect-square bg-maguito-white shadow-maguito-lg relative">
              <img src="/winking-maguito.gif" alt="Wizard" className="w-full h-full object-cover scale-110 hover:scale-110 transition-all duration-700" />
      ...
      <section className="space-y-10 md:space-y-16">
        <div className="text-center space-y-4 md:space-y-6 px-4">
          <h2 className="text-3xl sm:text-5xl md:text-6xl font-black text-maguito-black uppercase italic tracking-tighter">Los Componentes</h2>
          <p className="text-lg md:text-2xl font-bold text-gray-700 max-w-2xl mx-auto">Elementos táctiles con carácter, alma y muchas curvas (o no tantas 👀).</p>
        </div>
          ...
          <Card className="bg-maguito-red/5 border-4 hover:scale-[1.02] transition-all" paddingSize="lg" shadowColor="red">
            ...
            >
              <div className="h-40 md:h-56 bg-gray-200 rounded-maguito-sm flex items-center justify-center relative overflow-hidden">
                <img src="/thinking.png" className="w-full h-full object-cover grayscale transition-all group-hover:grayscale-0 group-hover:scale-110 duration-500" />
      ...
      <section className="bg-maguito-white border-4 border-maguito-black rounded-maguito-lg p-8 sm:p-16 md:p-32 shadow-maguito-lg text-center space-y-12 md:space-y-24 relative overflow-hidden">
        ...
        <div className="space-y-6 md:space-y-8 relative z-10 px-2">
          <h2 className="text-3xl sm:text-5xl md:text-7xl font-black uppercase italic tracking-tighter text-maguito-black leading-tight md:leading-none">¿Por qué usar <span className="text-maguito-orange">MaguitoUI?</span></h2>
          <p className="text-lg md:text-2xl font-bold text-gray-700 max-w-3xl mx-auto leading-relaxed">No más interfaces aburridas y genéricas. Destacá con un diseño audaz, formas amigables y mucho aire para que tu contenido brille.</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-16 relative z-10">
          <div className="space-y-4 md:space-y-8 group">
            ...
            <div className="space-y-2 md:space-y-4">
              ...
              <p className="text-base md:text-lg font-bold text-gray-600 leading-relaxed">Modifica cada píxel con facilidad. Nuestros componentes utilizan clases estándar de Tailwind y variables de alquimia.</p>
            </div>
          </div>
          <div className="space-y-4 md:space-y-8 group">
            ...
            <div className="space-y-2 md:space-y-4">
              <h3 className="font-black text-2xl md:text-3xl uppercase tracking-tighter italic text-maguito-black">Redondeado (o no!)</h3>
              <p className="text-base md:text-lg font-bold text-gray-600 leading-relaxed">Trazos gruesos y curvas orgánicas o cuadradas (como quieras!). Diseñada para proyectos que requieren una identidad lúdica y confiable.</p>
            </div>
          </div>
          <div className="space-y-4 md:space-y-8 group">
            ...
            <div className="space-y-2 md:space-y-4">
              <h3 className="font-black text-2xl md:text-3xl uppercase tracking-tighter italic text-maguito-black">Rendimiento Increíble</h3>
              <p className="text-base md:text-lg font-bold text-gray-600 leading-relaxed">Sin complicaciones, puro rendimiento. Optimizado para una carga rápida y una experiencia de usuario ágil y fluida.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="bg-maguito-black rounded-maguito-lg p-8 sm:p-16 md:p-32 text-center space-y-8 md:space-y-12 shadow-maguito-lg border-4 border-maguito-black relative">
        ...
        <div className="flex flex-col sm:flex-row items-center gap-4 md:gap-8 justify-center pt-8 md:pt-12 relative z-10">
          <Button size="lg" className="w-full sm:w-auto bg-maguito-yellow hover:bg-[#ffe180] h-16 md:h-24 px-10 md:px-16 text-xl md:text-3xl italic tracking-tighter" onClick={() => navigate('/installation')}>Instalar Paquete</Button>
          <Button size="lg" variant="outline" className="w-full sm:w-auto text-maguito-white border-maguito-white hover:bg-maguito-white hover:text-maguito-black hover:border-maguito-white h-16 md:h-24 px-10 md:px-16 text-xl md:text-3xl italic tracking-tighter" onClick={() => navigate('/intro')}>Conocé Más</Button>
        </div>
      </section>
    </div>
  );
